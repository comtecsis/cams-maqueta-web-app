...
{
    // eperez: MvcConfig
    public static final String PATH_TEMPLATES_THYMELEAF = "/";
    public static final String SUFFIX_HTML_THYMELEAF = ".html";
    public static final String SUFFIX_HTML_JSP = ".jsp";
    ...
    public static final String RESOURCES_LOCATION = "/";
